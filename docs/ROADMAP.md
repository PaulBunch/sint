...
- [ ] Develop kinematic and mechanical scheme of the interface (topology, DoF layout, relocatable base concept) → [tasks-0004](tasks/0004-kinematic-and-mechanical-scheme.md)
